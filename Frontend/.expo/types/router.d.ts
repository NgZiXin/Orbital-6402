...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)\home\_layout` | `/(tabs)\home\calendar` | `/(tabs)\home\stats` | `/(tabs)\runningRoute` | `/..\assets\icons\happy` | `/..\assets\icons\sad` | `/..\components\form\fragments\accountDetails\birthday` | `/..\components\form\fragments\accountDetails\gender` | `/..\components\form\fragments\accountDetails\height` | `/..\components\form\fragments\accountDetails\password` | `/..\components\form\fragments\accountDetails\username` | `/..\components\form\fragments\accountDetails\weight` | `/..\components\form\fragments\workoutDetails\fitnessLevel` | `/..\components\form\fragments\workoutDetails\healthConditions` | `/..\components\form\fragments\workoutDetails\muscleGroups` | `/..\components\form\fragments\workoutDetails\numExercise` | `/..\components\form\fragments\workoutDetails\otherRemarks` | `/..\components\form\full\edit` | `/..\components\form\full\workout` | `/..\components\form\validationSchema\login` | `/..\components\form\validationSchema\signupAndEdit` | `/..\components\general\agendaCalendar` | `/..\components\general\asyncStorage` | `/..\components\general\customTextInput` | `/..\components\general\pageHeader` | `/..\components\general\progressBar` | `/..\components\general\submit` | `/..\components\general\table\data` | `/..\components\general\table\table` | `/..\components\modal\homePage\calendar` | `/..\components\modal\homePage\weekToggle` | `/..\components\modal\profilePage\bmi` | `/..\components\modal\profilePage\edit` | `/..\components\modal\profilePage\logout` | `/..\components\modal\profilePage\sync` | `/..\components\modal\workoutPage\muscleGroup\guide` | `/..\components\modal\workoutPage\muscleGroup\helper\customChips` | `/..\components\modal\workoutPage\muscleGroup\helper\footer` | `/..\components\modal\workoutPage\muscleGroup\helper\header` | `/..\components\modal\workoutPage\muscleGroup\helper\list` | `/..\components\modal\workoutPage\muscleGroup\muscleGroup` | `/..\components\modal\workoutPage\muscleGroup\validation` | `/..\components\modal\workoutPage\workout` | `/..\components\navigation\header` | `/..\components\navigation\homeHeader` | `/..\components\others\ThemedText` | `/..\components\others\ThemedView` | `/..\components\strava\LinkStrava` | `/..\styles\form` | `/..\styles\modal` | `/..\styles\table` | `/_sitemap` | `/calendar` | `/forum` | `/home` | `/location` | `/login` | `/profile` | `/runningRoute` | `/sign-up` | `/stats` | `/workout`;
