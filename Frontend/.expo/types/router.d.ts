...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/..\components\form\fragments\accountFields\birthday` | `/..\components\form\fragments\accountFields\gender` | `/..\components\form\fragments\accountFields\height` | `/..\components\form\fragments\accountFields\password` | `/..\components\form\fragments\accountFields\username` | `/..\components\form\fragments\accountFields\weight` | `/..\components\form\fragments\findNearestFields\choice` | `/..\components\form\fragments\findNearestFields\location` | `/..\components\form\fragments\findNearestFields\radius` | `/..\components\form\fragments\setGoalsFields\achievements` | `/..\components\form\fragments\setGoalsFields\totalHours` | `/..\components\form\fragments\setGoalsFields\totalKilometers` | `/..\components\form\fragments\setGoalsFields\workoutCount` | `/..\components\form\fragments\workoutFields\healthConditions` | `/..\components\form\fragments\workoutFields\otherRemarks` | `/..\components\form\fragments\workoutFields\runWorkoutFields\distance` | `/..\components\form\fragments\workoutFields\runWorkoutFields\duration` | `/..\components\form\fragments\workoutFields\runWorkoutFields\week` | `/..\components\form\fragments\workoutFields\weightWorkoutFields\fitnessLevel` | `/..\components\form\fragments\workoutFields\weightWorkoutFields\muscleGroups` | `/..\components\form\fragments\workoutFields\weightWorkoutFields\numExercise` | `/..\components\form\full\setGoals` | `/..\components\form\validationSchema\setGoals` | `/..\components\modal\general\about` | `/..\components\modal\general\stravaReSync` | `/..\components\modal\general\stravaSync` | `/_sitemap` | `/calendar` | `/forum` | `/home` | `/location` | `/login` | `/nearestGymPark` | `/profile` | `/runningRoute` | `/sign-up` | `/stats` | `/workout`;
