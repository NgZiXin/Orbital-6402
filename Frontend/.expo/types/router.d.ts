...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)\home` | `/..\components\form\fragments\accountDetails\birthday` | `/..\components\form\fragments\accountDetails\gender` | `/..\components\form\fragments\accountDetails\height` | `/..\components\form\fragments\accountDetails\password` | `/..\components\form\fragments\accountDetails\username` | `/..\components\form\fragments\accountDetails\weight` | `/..\components\form\fragments\workoutDetails\fitnessLevel` | `/..\components\form\fragments\workoutDetails\healthConditions` | `/..\components\form\fragments\workoutDetails\muscleGroups` | `/..\components\form\fragments\workoutDetails\numExercise` | `/..\components\form\fragments\workoutDetails\otherRemarks` | `/..\components\form\full\edit` | `/..\components\form\full\workout` | `/..\components\general\asyncStorage` | `/..\components\general\customTextInput` | `/..\components\general\pageHeader` | `/..\components\general\submit` | `/..\components\modal\profilePage\bmi` | `/..\components\modal\profilePage\edit` | `/..\components\modal\profilePage\logout` | `/..\components\modal\profilePage\sync` | `/..\components\modal\workoutPage\muscleGroup\footer` | `/..\components\modal\workoutPage\muscleGroup\guide` | `/..\components\modal\workoutPage\muscleGroup\header` | `/..\components\modal\workoutPage\muscleGroup\list` | `/..\components\modal\workoutPage\muscleGroup\muscleGroup` | `/..\components\modal\workoutPage\workout` | `/..\components\navigation\TabBarIcon` | `/..\components\navigation\header` | `/..\components\others\ThemedText` | `/..\components\others\ThemedView` | `/..\components\strava\LinkStrava` | `/_sitemap` | `/forum` | `/location` | `/login` | `/profile` | `/sign-up` | `/workout`;
