...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/..\components\general\textBox\textBox` | `/_sitemap` | `/calendar` | `/forum` | `/home` | `/location` | `/login` | `/profile` | `/runningRoute` | `/sampleData` | `/sign-up` | `/stats` | `/workout`;
