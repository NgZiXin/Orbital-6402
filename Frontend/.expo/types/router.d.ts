...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/..\Frontend\constants\Colors` | `/..\Frontend\hooks\useColorScheme` | `/..\Frontend\hooks\useColorScheme.web` | `/..\Frontend\hooks\useThemeColor` | `/_sitemap` | `/explore` | `/forum` | `/workout`;
