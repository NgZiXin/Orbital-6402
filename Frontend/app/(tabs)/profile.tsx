...
export default function Profile() {
    ...
    const getUserDetails = async () => { 
        ...
        const response = await fetch(`https://orbital6402-2e455ce4dc99.herokuapp.com/accounts/data`, { 
            method: 'GET', 
            headers: { 
                ...
                <View style={styles.profileWrapper}>
                    ...
                    */}
                    ...
                    {userDetails.length > 0 && userDetails[5][1] == "F" && (
                        <Image source={require('../../assets/images/female-pfp.jpg')} style={styles.pfp}/>
                    )}
